...
frappe.ui.form.on('Attendance', {
	...
	total_working_hours: function(frm) {	
		console.log(frm.doc.total_working_hours - frm.doc.not_available_for)	
		frm.set_value('actual_working_hours', frm.doc.total_working_hours - frm.doc.not_available_for )	
	...
	actual_working_hours: function(frm) {
		// Actual working hours will be the subtraction of the [not_available_for - total_working_hours] fields
		// if (frm.doc.status=='Absent'){
		// 	frm.set_value("day_appraisal_total", 0)
		// 	frm.set_value("work_status_points", 0)
		// 	frm.set_value("day_total_points", get_vacation_worked(frm.doc.working_in_a_vacation_)+frm.doc.day_appraisal_total+frm.doc.work_status_points)
